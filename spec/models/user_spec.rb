...
RSpec.describe User, type: :model do
  ...
  it 'should return last 3 posts' do
    ...
    user.posts.create(title: 'Post 1', text: 'Content 1', created_at: 3.days.ago)
    user.posts.create(title: 'Post 2', text: 'Content 2', created_at: 2.days.ago)
    user.posts.create(title: 'Post 3', text: 'Content 3', created_at: 1.day.ago)
    user.posts.create(title: 'Post 4', text: 'Content 4', created_at: Time.now)
